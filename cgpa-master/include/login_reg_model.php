        ...
        <div class="modal-body">
            <form class="form-horizontal" method="post" action="signup.php">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" placeholder="Enter the text" name="name" required="1" minlength="5">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label model_label">User Name</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" placeholder="Enter the text" name="username" required="1" minlength="5">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" placeholder="Enter the text" name="university" required="1" minlength="2">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-offset-10 col-sm-2">
